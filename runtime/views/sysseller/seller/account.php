		...
		<ul class="tabs">
			<li>
				<form action="<?php echo IUrl::creatUrl("");?>" method="get">
					...
					<input type="text" name='startDate' value='<?php echo $this->startDate;?>' class="Wdate" pattern='date' onFocus="WdatePicker()" empty />————
					<input type="text" name='endDate' value='<?php echo $this->endDate;?>' class="Wdate" pattern='date' onFocus="WdatePicker()" empty />
