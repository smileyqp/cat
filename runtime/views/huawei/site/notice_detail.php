...
<section class="breadcrumb">
	<span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>">首页</a> > <a href="<?php echo IUrl::creatUrl("/site/notice");?>">公告列表</a> > <?php echo isset($this->noticeRow['title'])?$this->noticeRow['title']:"";?>
</section>
<section class="web">
	<section class="article_main">
		<section class="article article_notice">
			<header>
				<h1 class="article_title"><?php echo isset($this->noticeRow['title'])?$this->noticeRow['title']:"";?></h1>
				<time class="article_date">发布日期：<?php echo isset($this->noticeRow['time'])?$this->noticeRow['time']:"";?></time>
			</header>
			<article class="article_content"><?php echo isset($this->noticeRow['content'])?$this->noticeRow['content']:"";?></article>
		</section>
	</section>
