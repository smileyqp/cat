...
<div class="bigweb">
<section class="prompt_page success">
	<i class="ico"></i>
	<article>

		<strong><?php echo IReq::get('message') ? IFilter::act(IReq::get('message'),'text') : '操作成功！';?></strong><br>
		您现在可以去：

		<?php $callback = plugin::trigger('getCallback')?>
		<?php if($callback){?>
		<a href="<?php echo IUrl::creatUrl("".$callback."");?>">继续操作 >></a>
		<?php }?>
