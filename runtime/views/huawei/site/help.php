...
<section class="breadcrumb">
	<span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>">首页</a> » <a href="<?php echo IUrl::creatUrl("/site/help_list/id/".$this->cat_row['id']."");?>"><?php echo isset($this->cat_row['name'])?$this->cat_row['name']:"";?></a>
</section>

<section class="web">
	<section class="article_main">
		<h2 class="main_head"><?php echo isset($this->help_row['name'])?$this->help_row['name']:"";?></h2>
		<section class="article">
			<article class="article_content"><?php echo isset($this->help_row['content'])?$this->help_row['content']:"";?></article>
		</section>
	</section>
	<!-- 文章详情侧边 -->
