...
<div class="content">
	<form action="<?php echo IUrl::creatUrl("/goods/model_del");?>" method="post">
		<table class="table list-table">
			...
			<caption>
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/goods/model_edit");?>'>
			...
			<tbody>
            	<?php $queryObj=Api::run('getListByModel');$resultData=$queryObj->find()?>
            	<?php foreach($items=$resultData as $key => $item){?>
				<tr>
					<td><input name="id[]" type="checkbox" value="<?php echo isset($item['id'])?$item['id']:"";?>" /></td>
					<td><?php echo isset($item['name'])?$item['name']:"";?></td>
					<td>
						<a href="<?php echo IUrl::creatUrl("/goods/model_edit/id/".$item['id']."");?>"><i class='operator fa fa-edit'></i></a>
						<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/goods/model_del/id/".$item['id']."");?>'})"><i class='operator fa fa-close'></i></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
