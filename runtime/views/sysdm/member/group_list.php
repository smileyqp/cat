...
<div class="content">
	<table id="list_table" class="table">
		...
		<caption>
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/member/group_edit");?>'>
                <i class="fa fa-plus"></i>添加用户组
            </a>
            <a class="btn btn-default" onclick="selectAll('check[]')">
                <i class="fa fa-check"></i>全选
            </a>
            <a class="btn btn-default" onclick="delModel({'form':'group_list',msg:'确定要删除选中的记录吗？'})">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<?php echo IUrl::creatUrl("/member/group_edit/gid/".$item['id']."");?>"><i class='operator fa fa-edit'></i></a>
					<a onclick="delModel({link:'<?php echo IUrl::creatUrl("/member/group_del/check/".$item['id']."");?>'})"><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
