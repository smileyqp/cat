...
<div class="content">
	<form action="<?php echo IUrl::creatUrl("/member/withdraw_update/type/del");?>" method="post">
		<table class="table list-table">
			...
			<caption>
                ...
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/member/withdraw_recycle/type/del");?>'>
			...
			<tbody>
                <?php $queryObj=Api::run('getListByWithdraw',array('is_del'=>'0'));$resultData=$queryObj->find()?>
				...
				<tr>
					...
					<td>
						<a href='<?php echo IUrl::creatUrl("/member/withdraw_detail/id/".$item['id']."");?>'><i class='operator fa fa-eye'></i></a>
						<a href='javascript:void(0)' onclick="delModel({link:'<?php echo IUrl::creatUrl("/member/withdraw_update/type/del/id/".$item['id']."");?>',msg:'确定要把此信息放入到回收站么？'});"><i class='operator fa fa-close'></i></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
