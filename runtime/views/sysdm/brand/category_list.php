...
<div class="content">
	<table class="table list-table">
			...
			<caption>
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/brand/category_edit");?>'>
		...
		<tbody>
			<?php $queryObj=Api::run('getListByBrandCategory');$resultData=$queryObj->find()?>
            <?php foreach($items=$resultData as $key => $item){?>
			<tr>
				<td><?php echo isset($item['name'])?$item['name']:"";?></td>
				<td>
					<a href="<?php echo IUrl::creatUrl("/brand/category_edit/cid/".$item['id']."");?>"><i class='operator fa fa-edit'></i></a>
					<a onclick="delModel({link:'<?php echo IUrl::creatUrl("/brand/category_del/cid/".$item['id']."");?>'})"><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
