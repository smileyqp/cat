...
<div class="content">
	...
	<table class="table list-table">
		...
		<caption>
            ...
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/order/delivery_recycle_list");?>'>
		...
		<tbody>
            <?php $queryObj=Api::run('getListByDeliveryDoc',array('if_del'=>'0'));$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td><a href="<?php echo IUrl::creatUrl("/order/delivery_show/id/".$item['id']."");?>"><i class='operator fa fa-eye'></i></a></td>
			</tr>
			<?php }?>
		</tbody>
	</table>
