...
<div class="content">
	...
	<table class="table list-table">
		...
		<caption>
            ...
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/order/collection_recycle_list");?>'>
		...
		<tbody>
            <?php $queryObj=Api::run('getListByCollection');$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td><a href="<?php echo IUrl::creatUrl("/order/collection_show/id/".$item['id']."");?>"><i class='operator fa fa-eye'></i></td>
			</tr>
			<?php }?>
		</tbody>
	</table>
