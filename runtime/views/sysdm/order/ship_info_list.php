...
<div class="content">
	<form action="<?php echo IUrl::creatUrl("/order/ship_info_del");?>" method="post">
	<table class="table list-table">
		...
		<caption>
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/order/ship_info_edit");?>'>
            ...
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/order/ship_recycle_list");?>'>
		...
		<tbody>
			<?php $queryObj=Api::run('getListByShipInfoList',array('is_del'=>0));$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td>
					...
					<a class='text-red' href="<?php echo IUrl::creatUrl("/order/ship_info_default/id/".$item['id']."/default/0");?>">取消默认</a>
					<?php }else{?>
					<a class="text-blue" href="<?php echo IUrl::creatUrl("/order/ship_info_default/id/".$item['id']."/default/1");?>">设为默认</a>
					<?php }?>
				</td>
				<td>
					<a href="<?php echo IUrl::creatUrl("/order/ship_info_edit/id/".$item['id']."");?>"><i class='operator fa fa-edit'></i></a>
					<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/order/ship_info_del/id/".$item['id']."");?>'})"><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
