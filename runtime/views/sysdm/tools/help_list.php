...
<div class="content">
	<form action="<?php echo IUrl::creatUrl("/tools/help_del");?>" method="post" name="article">
		<table class="table list-table">
			...
			<caption>
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/tools/help_edit");?>'>
                    <i class="fa fa-plus"></i>添加帮助
                </a>
			...
			<tbody>
				<?php $helpList=$this->query->find()?>
				<?php foreach($items=$helpList as $key => $item){?>
				<tr>
					...
					<td>
						<a href='<?php echo IUrl::creatUrl("/tools/help_edit/id/".$item['id']."");?>'><i class='operator fa fa-edit'></i></a>
						<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/tools/help_del/id/".$item['id']."");?>'});"><i class='operator fa fa-close'></i></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
