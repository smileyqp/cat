...
<div class="content">
	<form action="<?php echo IUrl::creatUrl("/tools/notice_del");?>" method="get" name="notice">
		<table class="table list-table">
			...
			<caption>
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/tools/notice_edit");?>'>
			...
			<tbody>
				<?php $queryObj=Api::run('getListByAnnouncementList');$resultData=$queryObj->find()?>
				...
				<tr>
					...
					<td>
						<a href='<?php echo IUrl::creatUrl("/tools/notice_edit/id/".$item['id']."");?>'><i class='operator fa fa-edit'></i></a>
						<a target="_blank" href='<?php echo IUrl::creatUrl("/site/notice_detail/id/".$item['id']."");?>'><i class='operator fa fa-eye'></i></a>
						<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/tools/notice_del/id/".$item['id']."");?>'});"><i class='operator fa fa-close'></i></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
