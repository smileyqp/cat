...
<div class="content">
	<form action="<?php echo IUrl::creatUrl("/tools/article_del");?>" method="post" name="article">
		<table class="table list-table">
			...
			<caption>
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/tools/article_edit");?>'>
			...
			<tbody>
                <?php $queryObj=Api::run('getListByArticleList');$resultData=$queryObj->find()?>
				...
				<tr>
					...
					<td>
						<a href='<?php echo IUrl::creatUrl("/tools/article_edit/id/".$item['id']."");?>'><i class='operator fa fa-edit'></i></a>
						<a target="_blank" href='<?php echo IUrl::creatUrl("/site/article_detail/id/".$item['id']."");?>'><i class='operator fa fa-eye'></i></a>
						<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/tools/article_del/id/".$item['id']."");?>'});"><i class='operator fa fa-close'></i></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
