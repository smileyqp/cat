...
<div class="content">
	<form action='<?php echo IUrl::creatUrl("/system/freight_del");?>' method='post' name='freightForm'>
		<table class="table list-table">
			<caption>
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/system/freight_edit");?>'>
                    <i class="fa fa-plus"></i>添加物流公司
                </a>
                ...
                <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/system/freight_recycle");?>'>
			...
			<tbody>
				<?php $queryObj=Api::run('getListByFreightCompany',array('is_del'=>'0'));$resultData=$queryObj->find()?>
				...
				<tr>
					...
					<td>
						<a href="<?php echo IUrl::creatUrl("/system/freight_edit/id/".$item['id']."");?>"><i class='operator fa fa-edit'></i></a>
						<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/system/freight_del/id/".$item['id']."");?>'});"><i class='operator fa fa-close'></i></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
