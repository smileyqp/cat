...
<div class="content">
	<form action="<?php echo IUrl::creatUrl("/system/delivery_operate");?>" method="post">
	<table class="table list-table">
		<caption>
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/system/delivery_edit");?>'>
            ...
            <a class="btn btn-default" href='<?php echo IUrl::creatUrl("/system/delivery_recycle");?>'>
		...
		<tbody>
			<?php $queryObj=Api::run('getListByDelivery',array('is_delete'=>'0'));$resultData=$queryObj->find()?>
            <?php foreach($items=$resultData as $key => $item){?>
			<tr>
				<td>
					<input name="id[]" type="checkbox" value="<?php echo isset($item['id'])?$item['id']:"";?>" />
				</td>
				...
				<td>
					<a href="<?php echo IUrl::creatUrl("/system/delivery_edit/id/".$item['id']."");?>">
						<i class='operator fa fa-edit'></i>
					</a>
					<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/system/delivery_operate/id/".$item['id']."");?>'})">
