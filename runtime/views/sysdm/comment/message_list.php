...
<div class="content">
	<table class="table list-table">
		...
		<tbody>
			<?php $queryObj=Api::run('getListByMessage');$resultData=$queryObj->find()?>
			...
			<tr>
				...
				<td>
					<a href="<?php echo IUrl::creatUrl("/comment/message_show/id/".$item['id']."");?>"><i class='operator fa fa-eye'></i></a>
					<a onclick="delModel({link:'<?php echo IUrl::creatUrl("/comment/message_del/check/".$item['id']."");?>'})"><i class='operator fa fa-close'></i></a>
				</td>
			</tr>
			<?php }?>
		</tbody>
